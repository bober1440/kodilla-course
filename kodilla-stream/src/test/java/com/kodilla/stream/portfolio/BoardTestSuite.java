...
public class BoardTestSuite {
    ...
    void testAddTaskListFindUsersTasks(){
        ...
        List<Task> taskList = project.getTaskLists().stream()
        ...
        assertEquals(user, taskList.get(0).getAssignedUser());
        assertEquals(user, taskList.get(1).getAssignedUser());
    }
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        long averageTime = sumTime / tasksQuantity;

        //Then
        assertEquals(3, tasksQuantity);
    ...
    @Test
    void testAddTaskListAverageWorkingOnTaskUsingAverage(){
        //Given
        Board project = prepareTestData();
